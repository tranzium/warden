...
import { dashboardHandler, listHandler, getHandler, startHandler, stopHandler, restartHandler, registerHandler, unregisterHandler, updateHandler } from './routes/services'
